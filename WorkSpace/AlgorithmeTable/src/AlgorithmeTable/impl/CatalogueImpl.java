 ...
 * </p>
 * <ul>
 *   <li>{@link AlgorithmeTable.impl.CatalogueImpl#getNom <em>Nom</em>}</li>
 *   <li>{@link AlgorithmeTable.impl.CatalogueImpl#getAlgorithme <em>Algorithme</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CatalogueImpl extends MinimalEObjectImpl.Container implements Catalogue {
	...
	protected EClass eStaticClass() {
		return AlgorithmeTablePackage.Literals.CATALOGUE;
	}
	...
	public void setNom(String newNom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgorithmeTablePackage.CATALOGUE__NOM, oldNom, nom));
	}
	...
	public EList<Algorithme> getAlgorithme() {
		if (algorithme == null) {
			algorithme = new EObjectContainmentWithInverseEList<Algorithme>(Algorithme.class, this, AlgorithmeTablePackage.CATALOGUE__ALGORITHME, AlgorithmeTablePackage.ALGORITHME__CATALOGUE);
		}
		return algorithme;
	}
