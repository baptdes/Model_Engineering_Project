 ...
 * </p>
 * <ul>
 *   <li>{@link AlgorithmeTable.impl.RessourceImpl#getType <em>Type</em>}</li>
 *   <li>{@link AlgorithmeTable.impl.RessourceImpl#getEmplacement <em>Emplacement</em>}</li>
 *   <li>{@link AlgorithmeTable.impl.RessourceImpl#getAlgorithme <em>Algorithme</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RessourceImpl extends MinimalEObjectImpl.Container implements Ressource {
	...
	protected EClass eStaticClass() {
		return AlgorithmeTablePackage.Literals.RESSOURCE;
	}
	...
	public void setType(TypeRessource newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgorithmeTablePackage.RESSOURCE__TYPE, oldType, type));
	}
	...
	public void setEmplacement(String newEmplacement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgorithmeTablePackage.RESSOURCE__EMPLACEMENT, oldEmplacement, emplacement));
	}
	...
	public Algorithme getAlgorithme() {
		if (eContainerFeatureID() != AlgorithmeTablePackage.RESSOURCE__ALGORITHME) return null;
	...
	public NotificationChain basicSetAlgorithme(Algorithme newAlgorithme, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newAlgorithme, AlgorithmeTablePackage.RESSOURCE__ALGORITHME, msgs);
		return msgs;
	}
	...
	public void setAlgorithme(Algorithme newAlgorithme) {
		if (newAlgorithme != eInternalContainer() || (eContainerFeatureID() != AlgorithmeTablePackage.RESSOURCE__ALGORITHME && newAlgorithme != null)) {
			...
			if (newAlgorithme != null)
				msgs = ((InternalEObject)newAlgorithme).eInverseAdd(this, AlgorithmeTablePackage.ALGORITHME__RESSOURCE, Algorithme.class, msgs);
			msgs = basicSetAlgorithme(newAlgorithme, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgorithmeTablePackage.RESSOURCE__ALGORITHME, newAlgorithme, newAlgorithme));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlgorithmeTablePackage.RESSOURCE__ALGORITHME:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case AlgorithmeTablePackage.RESSOURCE__ALGORITHME:
				return eInternalContainer().eInverseRemove(this, AlgorithmeTablePackage.ALGORITHME__RESSOURCE, Algorithme.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AlgorithmeTablePackage.RESSOURCE__TYPE:
				return getType();
			case AlgorithmeTablePackage.RESSOURCE__EMPLACEMENT:
