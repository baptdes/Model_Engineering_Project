 ...
 * </p>
 * <ul>
 *   <li>{@link script.impl.SortieImpl#getEntree <em>Entree</em>}</li>
 *   <li>{@link script.impl.SortieImpl#getNom <em>Nom</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SortieImpl extends MinimalEObjectImpl.Container implements Sortie {
	...
	public EList<Entree> getEntree() {
		if (entree == null) {
			entree = new EObjectWithInverseResolvingEList<Entree>(Entree.class, this, ScriptPackage.SORTIE__ENTREE,
					ScriptPackage.ENTREE__SORTIE);
		}
		return entree;
	}
	...
	public void setNom(String newNom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScriptPackage.SORTIE__NOM, oldNom, nom));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ScriptPackage.SORTIE__ENTREE:
