...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>algorithms</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class AlgorithmsExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.algorithms"));
				Algorithme root = AlgorithmsFactory.eINSTANCE.createAlgorithme();
