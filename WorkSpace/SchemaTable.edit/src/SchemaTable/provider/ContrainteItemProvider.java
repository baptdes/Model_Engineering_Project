		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Contrainte_colonnes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Contrainte_colonnes_feature", "_UI_Contrainte_type"),
				 SchemaTablePackage.Literals.CONTRAINTE__COLONNES,
				 true,
				 false,
				 true,
				 null,
