...
public class ScriptItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNomPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Script_nom_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Script_nom_feature", "_UI_Script_type"),
						ScriptPackage.Literals.SCRIPT__NOM, true, false, false,
	...
	protected void addResultatPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Script_resultat_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Script_resultat_feature",
								"_UI_Script_type"),
						ScriptPackage.Literals.SCRIPT__RESULTAT, true, false, true, null, null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ScriptPackage.Literals.SCRIPT__BLOCS,
				ScriptFactory.eINSTANCE.createFonctionUnaire()));
