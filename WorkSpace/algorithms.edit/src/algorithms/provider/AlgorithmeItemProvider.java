...
/**
 * This is the item provider adapter for a {@link algorithms.Algorithme} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AlgorithmeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AlgorithmsPackage.Literals.ALGORITHME__NOM,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AlgorithmsPackage.Literals.ALGORITHME__DOCUMENTATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AlgorithmsPackage.Literals.ALGORITHME__RESSOURCE);
			childrenFeatures.add(AlgorithmsPackage.Literals.ALGORITHME__PORT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AlgorithmsPackage.Literals.ALGORITHME__RESSOURCE,
				 AlgorithmsFactory.eINSTANCE.createRessource()));

		newChildDescriptors.add
			(createChildParameter
				(AlgorithmsPackage.Literals.ALGORITHME__PORT,
				 AlgorithmsFactory.eINSTANCE.createPort()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return AlgorithmsEditPlugin.INSTANCE;
	}
