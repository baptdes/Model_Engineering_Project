/**
 */
package AlgorithmeTable.provider;
...
/**
 * This is the item provider adapter for a {@link AlgorithmeTable.Algorithme} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AlgorithmeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AlgorithmeTablePackage.Literals.ALGORITHME__NOM,
				 true,
				 false,
				 false,
	...
	protected void addDocumentationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Algorithme_documentation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Algorithme_documentation_feature", "_UI_Algorithme_type"),
				 AlgorithmeTablePackage.Literals.ALGORITHME__DOCUMENTATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AlgorithmeTablePackage.Literals.ALGORITHME__RESSOURCE);
			childrenFeatures.add(AlgorithmeTablePackage.Literals.ALGORITHME__PORT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AlgorithmeTablePackage.Literals.ALGORITHME__RESSOURCE,
				 AlgorithmeTableFactory.eINSTANCE.createRessource()));

		newChildDescriptors.add
			(createChildParameter
				(AlgorithmeTablePackage.Literals.ALGORITHME__PORT,
				 AlgorithmeTableFactory.eINSTANCE.createPort()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return AlgorithmeTableEditPlugin.INSTANCE;
	}
