 ...
 *   <li>{@link algorithms.impl.PortImpl#getAlgorithme <em>Algorithme</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PortImpl extends MinimalEObjectImpl.Container implements Port {
	...
	public void setConstant(boolean newConstant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgorithmsPackage.PORT__CONSTANT, oldConstant, constant));
	}
	...
	public void setDirection(Direction newDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgorithmsPackage.PORT__DIRECTION, oldDirection, direction));
	}
	...
	public Algorithme getAlgorithme() {
		if (eContainerFeatureID() != AlgorithmsPackage.PORT__ALGORITHME) return null;
	...
	public NotificationChain basicSetAlgorithme(Algorithme newAlgorithme, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newAlgorithme, AlgorithmsPackage.PORT__ALGORITHME, msgs);
		return msgs;
	}
	...
	public void setAlgorithme(Algorithme newAlgorithme) {
		if (newAlgorithme != eInternalContainer() || (eContainerFeatureID() != AlgorithmsPackage.PORT__ALGORITHME && newAlgorithme != null)) {
			...
			if (newAlgorithme != null)
				msgs = ((InternalEObject)newAlgorithme).eInverseAdd(this, AlgorithmsPackage.ALGORITHME__PORT, Algorithme.class, msgs);
			msgs = basicSetAlgorithme(newAlgorithme, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgorithmsPackage.PORT__ALGORITHME, newAlgorithme, newAlgorithme));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlgorithmsPackage.PORT__ALGORITHME:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case AlgorithmsPackage.PORT__ALGORITHME:
				return eInternalContainer().eInverseRemove(this, AlgorithmsPackage.ALGORITHME__PORT, Algorithme.class, msgs);
		}
