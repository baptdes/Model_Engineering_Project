 ...
 *   <li>{@link algorithms.impl.AlgorithmeImpl#getRessource <em>Ressource</em>}</li>
 *   <li>{@link algorithms.impl.AlgorithmeImpl#getPort <em>Port</em>}</li>
 *   <li>{@link algorithms.impl.AlgorithmeImpl#getCatalogue <em>Catalogue</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AlgorithmeImpl extends MinimalEObjectImpl.Container implements Algorithme {
	...
	public void setDocumentation(String newDocumentation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgorithmsPackage.ALGORITHME__DOCUMENTATION, oldDocumentation, documentation));
	}
	...
	public NotificationChain basicSetRessource(Ressource newRessource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlgorithmsPackage.ALGORITHME__RESSOURCE, oldRessource, newRessource);
	...
	public void setRessource(Ressource newRessource) {
		if (newRessource != ressource) {
			...
			if (ressource != null)
				msgs = ((InternalEObject)ressource).eInverseRemove(this, AlgorithmsPackage.RESSOURCE__ALGORITHME, Ressource.class, msgs);
			if (newRessource != null)
				msgs = ((InternalEObject)newRessource).eInverseAdd(this, AlgorithmsPackage.RESSOURCE__ALGORITHME, Ressource.class, msgs);
			msgs = basicSetRessource(newRessource, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgorithmsPackage.ALGORITHME__RESSOURCE, newRessource, newRessource));
	}
	...
	public EList<Port> getPort() {
		if (port == null) {
			port = new EObjectContainmentWithInverseEList<Port>(Port.class, this, AlgorithmsPackage.ALGORITHME__PORT, AlgorithmsPackage.PORT__ALGORITHME);
		}
		return port;
	}
	...
	public Catalogue getCatalogue() {
		if (eContainerFeatureID() != AlgorithmsPackage.ALGORITHME__CATALOGUE) return null;
	...
	public NotificationChain basicSetCatalogue(Catalogue newCatalogue, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newCatalogue, AlgorithmsPackage.ALGORITHME__CATALOGUE, msgs);
		return msgs;
	}
	...
	public void setCatalogue(Catalogue newCatalogue) {
		if (newCatalogue != eInternalContainer() || (eContainerFeatureID() != AlgorithmsPackage.ALGORITHME__CATALOGUE && newCatalogue != null)) {
			...
			if (newCatalogue != null)
				msgs = ((InternalEObject)newCatalogue).eInverseAdd(this, AlgorithmsPackage.CATALOGUE__ALGORITHME, Catalogue.class, msgs);
			msgs = basicSetCatalogue(newCatalogue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgorithmsPackage.ALGORITHME__CATALOGUE, newCatalogue, newCatalogue));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlgorithmsPackage.ALGORITHME__RESSOURCE:
				if (ressource != null)
					msgs = ((InternalEObject)ressource).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlgorithmsPackage.ALGORITHME__RESSOURCE, null, msgs);
			...
			case AlgorithmsPackage.ALGORITHME__CATALOGUE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case AlgorithmsPackage.ALGORITHME__CATALOGUE:
				return eInternalContainer().eInverseRemove(this, AlgorithmsPackage.CATALOGUE__ALGORITHME, Catalogue.class, msgs);
		}
