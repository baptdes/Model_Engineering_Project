...
public class AlgorithmsPackageImpl extends EPackageImpl implements AlgorithmsPackage {
	...
	public static AlgorithmsPackage init() {
		...
		AlgorithmsPackageImpl theAlgorithmsPackage = registeredAlgorithmsPackage instanceof AlgorithmsPackageImpl ? (AlgorithmsPackageImpl)registeredAlgorithmsPackage : new AlgorithmsPackageImpl();
	...
	public void initializePackageContents() {
		...
		addEEnumLiteral(typeRessourceEEnum, TypeRessource.MATLAB);
